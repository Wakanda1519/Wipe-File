...
*   **⚡ Scenarios & Operations:** Создавайте именованные операции (например, "Очистка логов" или "Сброс кэша").
*   **🎯 Smart Filtering:** Удаление файлов по конкретным расширениям (например, `*.log`, `*.tmp`) внутри указанных папок.
*   **📂 Target Cleaning:** Возможность удалять конкретные файлы или целые директории.
*   **desktop UI:** Удобный графический интерфейс без необходимости использовать консоль.
